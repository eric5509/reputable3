...
export default function Strategy() {
  ...
  return (
    ...
    >
      ...
      <div className="flex text-[22px] lg:text-[27px] overflow-hidden whitespace-nowrap mt-10 lg:mt-14">
      ...
      <div className="flex text-[22px] lg:text-[27px] overflow-hidden whitespace-nowrap mt-9 lg:mt-14">
