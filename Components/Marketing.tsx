...
export default function Marketing() {
  const details = [
    {
      img: Bison,
      title: "Going buliish on hedge fund branding",
      subtitle: "Branding",
    },
    {
      img: Covalent,
  ...
  return (
    <div className="py-14 sm:py-16 padding bg-blue-5  0" id="work">
          ...
          {details.map((data, key) => (
            <div className="snap-start duration-300" key={key}>
              ...
              <div className="mt-2 ">
                ...
                <p className="text-lg lg:text-xl text-gray-600">{data.subtitle}</p>
              </div>
            </div>
          ))}
        </div>
