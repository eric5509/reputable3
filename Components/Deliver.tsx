...
export default function Deliver() {
  ...
  return (
    <div
      ...
      id="about"
    >
      <div className="parentContainer grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-14 sm:gap-y-20 lg:gap-y-28">
        {data.map((item, key) => (
          <motion.div
            variants={var1}
            whileInView="animate"
          ...
          >
            ...
            <p className="text-sm text-gray-500">{item[3]}</p>
          </motion.div>
        ))}
      </div>
